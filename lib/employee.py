...
class Employee:
    ...
    def save(self):
        """Insert new row, update id, and store in cache"""
        sql = """
    ...
    def update(self):
        """Update row to match current object"""
        sql = """
            UPDATE employees
    ...
    def delete(self):
        """Delete row, remove from cache, reset id"""
    ...
    def create(cls, name, job_title, department_id):
        """Initialize and persist new Employee"""
    ...
    def instance_from_db(cls, row):
        """Return an Employee instance from a DB row, using cache"""
    ...
    def reviews(self):
        """Return list of Review objects associated with this employee"""
